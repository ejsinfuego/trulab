...
class Footer extends Component {
    render(){
        return (
            <footer className="footer footer-center p-10 bg-default text-primary-content">
                <div>
